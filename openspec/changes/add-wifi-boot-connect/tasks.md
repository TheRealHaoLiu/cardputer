...
## 1. Implementation
- [x] 1.1 Update boot.py to check wifi_on NVS setting
- [x] 1.2 Update boot.py to load credentials from NVS("wifi")
- [x] 1.3 Update boot.py to connect if enabled and credentials exist
