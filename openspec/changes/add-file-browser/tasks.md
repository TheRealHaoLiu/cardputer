...
- [ ] **5. Implement SD card availability check**
...
- [ ] **6. Implement storage location selection**
...
- [ ] **7. Refactor _navigate_up() for multi-storage**
...
- [ ] **16. Add entry to apps/manifest.json**
  - Add "file_browser": "File Browser" entry

- [ ] **17. Remove entry from apps/demo/manifest.json**
  - Remove "sdcard_demo": "SD Card Demo" entry

- [ ] **18. Delete apps/demo/sdcard_demo.py**
